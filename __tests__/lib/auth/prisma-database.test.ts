...
describe("PrismaUserDatabase", () => {
  describe("findByEmail", () => {
    ...
    it("returns null when not found", async () => {
      ...
      const result = await PrismaUserDatabase.findByEmail(
  ...
  describe("validateUser", () => {
    it("returns user for valid credentials", async () => {
      ...
      const result = await PrismaUserDatabase.validateUser(
        "test@example.com",
        "correctPassword",
      );
  ...
  describe("updateUser", () => {
    it("updates user data", async () => {
      ...
      const result = await PrismaUserDatabase.updateUser("user-123", {
        name: "Updated Name",
      });
