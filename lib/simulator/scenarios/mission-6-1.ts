...
const scenes: Scene[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: "name-marcus-by-name",
        text: '"Marcus just took my work. I need your read."',
        tactic: "Direct naming, no emotion. Kaya is listening for whether you\'ll say the word out loud.",
        nextSceneId: "kaya-private-meeting",
        isOptimal: true,
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        id: "ask-her-pick",
        text: '"Which one would you do if you were me?"',
        tactic: "Let Kaya reveal her own preference. Her answer is the play she\'d back if it went sideways.",
        nextSceneId: "next-day-paper-trail",
        isOptimal: true,
      },
      {
