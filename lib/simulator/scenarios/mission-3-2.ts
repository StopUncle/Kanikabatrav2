...
const scenes: Scene[] = [
...

  {
    ...
    choices: [
      ...
      {
        id: "stop-replying",
        text: "Stop replying. Put the phone face-down.",
        tactic: "You said short. She's past short. The contract is yours to enforce by ending the conversation.",
        nextSceneId: "maris-rejects-withdrawal",
        isOptimal: true,
      },
      {
        id: "return-frame",
        text: "\"That's a call conversation, not a text conversation, and I'm not available for that tonight.\"",
        tactic: "Name her frame back at her and close the door. Crisp, warm, final.",
        nextSceneId: "maris-rejects-referral",
        isOptimal: true,
      },
    ],
...

  {
    ...
    choices: [
      ...
      {
        id: "name-the-tell",
        text: '"Real crisis takes the crisis resource. You refused it. I noticed."',
        tactic: "Name the tell to her face. She can\'t argue it without confirming it.",
        nextSceneId: "ending-referral-held",
        isOptimal: true,
      },
      {
        id: "silent-close",
        text: "Don't reply. Archive the thread.",
        tactic: "Archiving without blocking leaves the door closed but not slammed. She can't escalate what you don't see.",
        nextSceneId: "ending-referral-held",
        isOptimal: true,
      },
    ],
...

  {
    ...
    choices: [
      ...
      {
        id: "receipt-the-walk-back",
        text: '"Glad it\'s not urgent. Catch up properly some other time."',
        tactic: "Acknowledge her walk-back, treat 'some other time' as indefinite. No appointment booked.",
        nextSceneId: "ending-filtered",
        isOptimal: true,
      },
      {
        id: "dry-goodnight",
        text: '"Night."',
        tactic: "One word. The night is over. She'll try again in a week with a different opener.",
        nextSceneId: "ending-filtered",
        isOptimal: true,
      },
    ],
