...
const scenes: Scene[] = [
...

  {
    ...
    choices: [
      ...
      {
        id: "yes-lets",
        text: '"Yes. Let\'s have a nice dinner. I\'d like that."',
        tactic: "Accept the stated wish at face value. Removes the escalation ladder without conceding the fact.",
        nextSceneId: "mother-behaves-briefly",
        isOptimal: true,
      },
      {
        id: "include-ren",
        text: "Look at Ren. \"You noticed it too, didn't you.\"",
        tactic: "Pull Ren in as witness. The triangulation only works if the other two pretend not to see it.",
        nextSceneId: "mother-escalates-wounded",
      },
    ],
  },
...

  {
    ...
    choices: [
      ...
      {
        id: "reflect-concern",
        text: "\"I'm fine. Are YOU okay? You seem worried.\"",
        tactic: "Reflect the 'concern' back as a question about her. She won't know how to hold it.",
        nextSceneId: "ending-grey-rock-held",
        isOptimal: true,
      },
      {
