  ...
  html: (r) =>
    shell(
      ...
      `
        ...
        <p style="font-size:15.5px;line-height:1.7;color:#efe7d6;margin:0 0 18px 0;">
          Members get the Sociopathic Dating Bible at $9.99 (normally $24.99) as a separate purchase. Or grab the book + 1-month bundle for $39 from the book page if you want both at once. <strong style="color:#f3d98a;">${MEMBERSHIP.monthly}, cancel anytime.</strong>
        </p>
        <p style="font-size:15.5px;line-height:1.7;color:#efe7d6;margin:0 0 28px 0;">
  ...
  html: (r) =>
    shell(
      ...
      `
        ...
        <p style="font-size:15.5px;line-height:1.7;color:#efe7d6;margin:0 0 28px 0;">
          <strong style="color:#f3d98a;">${MEMBERSHIP.monthly}.</strong> Cancel anytime. The book comes free with it. The simulator, the courses, the daily psychology drops, and now this.
        </p>
      `,
