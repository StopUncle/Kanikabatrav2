...
export const COACHING_PACKAGES = [
  {
    ...
    bundleSessions: 3,
    description:
      "Rebuild your psychological operating system. Access the headspace where fear doesn't vote, decisions come fast, and you operate with clarity when others spiral.",
    longDescription:
  ...
  },
  {
    ...
    bundleSessions: 3,
    description:
      "Become the person everyone watches but can't read. Master presence that commands respect, read people in minutes, and control any room without saying a word.",
    longDescription:
  ...
  },
  {
    ...
    bundleSessions: 3,
    description:
      "Stop reacting to life. Start designing it. Build the psychology, systems, and leverage of someone who creates circumstances instead of responding to them.",
    longDescription:
