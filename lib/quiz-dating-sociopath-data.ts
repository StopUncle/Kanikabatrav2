...
export const QUADRANT_PROFILES: Record<DatingQuadrant, DatingQuadrantProfile> = {
  ...
  "gut-knows": {
    ...
    notes: [
      "Sometimes the gut is reading an old relationship and miscoding the new one. If your internal score has the same shape as the worst weeks of a previous relationship, that is information about your nervous system, not necessarily about your current partner.",
...
export const DATING_QUIZ_FAQ = [
  ...
  },
  {
    ...
    answer:
      "It depends. If the anger is general (they don't like online quizzes), that's just preference. If the anger is specifically focused on you researching personality disorders or coercive control, that is itself a behavioural red-flag item that this quiz does not include explicitly but probably should. Most people in healthy relationships do not police their partner's reading.",
  },
  {
    question:
