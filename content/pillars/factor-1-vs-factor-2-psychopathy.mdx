...
faq:
  ...
  - q: "Is Factor 2 psychopathy the same as ASPD?"
    a: "No, but they overlap heavily. The DSM's ASPD criteria are built mostly around behaviour (deceitfulness, impulsivity, aggression, irresponsibility), and those criteria map far more onto Factor 2 than Factor 1. That is why many people diagnosed with ASPD present as Factor 2, while a high-Factor-1 person can meet the same criteria and look completely different in practice. ASPD is the DSM diagnosis; Factor 2 is a dimension of the PCL-R. Related frameworks, not synonyms."
...
**Is Factor 2 psychopathy the same as ASPD?**
No, but they overlap heavily. The DSM's ASPD criteria are built mostly around behaviour: deceitfulness, impulsivity, aggression, irresponsibility. Those criteria map far more onto Factor 2 than Factor 1, which is why many people diagnosed with ASPD present as Factor 2, while a high-Factor-1 person can meet the same criteria and look completely different in practice. ASPD is the DSM diagnosis; Factor 2 is a dimension of the PCL-R. Related frameworks, not synonyms.
