...
keyFacts:
  - "Dark psychology is the study of how people use covert techniques (manipulation, persuasion, coercion, and exploitation) to influence others."
  - "It draws on the Dark Triad and Cluster B research; roughly 1 to 5 percent of people score high on the dark traits."
  - "Studying it correlates with reduced victimisation and does not make someone more manipulative: it closes an information gap that was already being used against you."
tldr:
  - "Dark psychology is the study of how people use covert techniques to manipulate, persuade, and exploit others. Learning it does not make you a predator, it makes you immune to becoming one's target."
  - "The Dark Triad (narcissism, Machiavellianism, psychopathy) and Dark Tetrad (add sadism) are the personality clusters behind it. Roughly 1 to 5 percent of people score high."
  - "Manipulators do not target weak people, they target the empathetic, agreeable, isolated, guilt-prone, and trusting. Your strengths are their entry points."
  - "The four-phase cycle (identify, idealise, isolate, exploit) is identical across romance, work, cults, and propaganda. Naming a tactic as it happens collapses its power."
...
coverImage: "/api/og?title=What%20Is%20Dark%20Psychology%3F%20The%20Complete%202026%20Guide&subtitle=Dark%20Psychology"
...
This page is the umbrella. Each branch of dark psychology has its own in-depth pillar guide, and they all connect back here:

- **[ASPD and Sociopathy](/guide/aspd-sociopathy-complete-guide)** is the diagnosis behind the "sociopath" label, written by someone who has it.
- **[Factor 1 vs Factor 2 Psychopathy](/guide/factor-1-vs-factor-2-psychopathy)** is the precise clinical model of the cold, calculated type versus the impulsive one.
- **[Narcissism](/guide/narcissism-complete-guide)** covers the covert and overt types, the playbook, and how to spot it.
- **[The Dark Triad](/guide/dark-triad-complete-guide)** is narcissism, Machiavellianism, and psychopathy in one person.
- **[Manipulation Tactics](/guide/manipulation-tactics-complete-guide)** defuses the named techniques one by one.
- **[Cluster B Disorders](/guide/cluster-b-complete-guide)** maps the narcissistic, borderline, antisocial, and histrionic patterns.
- **[Attachment Styles](/guide/attachment-styles-complete-guide)** explains why you bond the way you do, and how to change it.
- **[The High-Value Woman](/guide/high-value-woman-complete-guide)** is the dark-feminine dating strategy layer.
