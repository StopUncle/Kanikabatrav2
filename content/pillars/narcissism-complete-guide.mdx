...
keyFacts:
  - "Narcissism runs on a spectrum from a normal trait to Narcissistic Personality Disorder (NPD), a Cluster B diagnosis affecting roughly 1 percent of people."
  - "Covert (vulnerable) narcissists carry the same entitlement and lack of empathy as overt ones but express it through victimhood and quiet superiority, which makes them harder to spot."
  - "The narcissistic-abuse cycle is idealise, devalue, discard, and hoover; recognising the pattern is the defence."
...
author: "Kanika Batra"
youtubeId: "Zz5CX5q2osU"
youtubeTitle: "Diagnosed Sociopath Reveals How to Control and Destroy a Narcissist"
isPillar: true
faq:
...
The covert type does more damage precisely because it does not look like narcissism. It looks like sensitivity. If your partner seems gentle but you feel slowly drained, confused, and always apologising, read the [covert narcissist husband pattern](/blog/covert-narcissist-husband-signs-wife-pattern) and [covert vs overt narcissist](/blog/covert-vs-overt-narcissist-differences). And if you grew up with one, the [narcissistic mother and the daughter pattern](/blog/narcissistic-mother-signs-daughter-pattern) is required reading, because that wound sets the template for every relationship after it.
