...
tldr:
  - "Anxious attachment style is not neediness, it is a nervous system calibrated in childhood by an inconsistent caregiver to read small drops in closeness as total threat."
  - "You keep picking avoidants and covert narcissists because the chase feels like home. Familiar is not the same as good, it is just what was installed."
  - "Healing is recalibration, not a cure: name the spike as a pattern, refuse the protest behaviour once, date secure deliberately, and tolerate the boredom until calm reads as rest."
  - "The work takes years, not weekends. The spike shortens, the pattern loosens, and you stop being moved by a storm you used to mistake for love."
...
coverImage: "/api/og?title=Anxious%20Attachment&subtitle=Dark%20Psychology"
