...
tldr:
  - "The narcissist playbook is simple once you see the wound: narcissism is a defensive performance built on top of a collapsed self that cannot survive unaided reality."
  - "Every narcissist needs narcissistic supply, a steady input of external validation. Without it the structure collapses into rage or depression within weeks."
  - "The three-phase cycle (idealise, devalue, discard) is not a strategy, it's an involuntary mechanism that runs on every significant relationship they have, friends and family included."
  - "They're the easiest type to read in the room. The tells (a too-clean origin story, instant soulmate framing, loyalty micro-tests, no genuine curiosity about you) show up within three conversations."
...
coverImage: "/api/og?title=The%20Narcissist%20Playbook&subtitle=Dark%20Psychology"
