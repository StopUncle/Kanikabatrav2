...
tldr:
  - "Dark feminine energy is not an aesthetic, it is an architecture: a configuration of mindset, boundaries, and behaviour that reclaims the parts of femininity (mystery, strategic selfishness, fierce boundaries) culture trained you to suppress."
  - "The framework runs on five archetypes (Seductress, Witch, Queen, Temptress, Dark Mother) and five pillars (Radical Self-Priority, Cultivated Mystery, Emotional Mastery, Strategic Seduction, Fierce Boundaries)."
  - "\"Dark\" means shadow, not cruel. You need both light and dark feminine, and the mature target is integration of both, with discernment about when each serves."
  - "The terminal evolution is not the queen (who still needs validation) but the empress, whose power is structural and self-sustaining. You reign because you stop waiting to be crowned."
...
coverImage: "/api/og?title=Dark%20Feminine%20Energy&subtitle=The%20Complete%202026%20Framework"
