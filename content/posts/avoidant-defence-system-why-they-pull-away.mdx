...
tldr:
  - "Avoidant attachment is not coldness, it is a childhood defence system that reads closeness itself as a threat, so the better the relationship goes the harder it pulls away."
  - "Deactivation is a reflex, not a decision. The more you chase during it, the harder the defence engages, which is why avoidants sabotage relationships that are working."
  - "Two types run different logic: dismissive (strong self, others not worth it) and fearful (weak self, others will hurt me, wants closeness and flinches at once)."
  - "Giving space and giving more love both backfire. The real answer is to stop managing their defence and decide whether you can live with it as permanent."
...
coverImage: "/api/og?title=The%20Avoidant's%20Defence%20System&subtitle=Why%20They%20Pull%20Away%20When%20You%20Get%20Close"
