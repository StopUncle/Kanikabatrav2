...
tldr:
  - "The Mask Collection is the set of four personas every sociopath wears, rotating them based on the target, the context, and the strategic objective."
  - "The four masks: the Ingenue disarms cynics, the Therapist extracts information, the Femme Fatale exploits thrill-seekers, the Boring Wife secures commitment."
  - "It isn't lying about facts. Each mask is a complete operating mode the sociopath genuinely runs, which is why lie-detection fails on a maintained one."
  - "The one tell across all four is consistency failure: tired, drunk, or stressed, a different mask bleeds through. Watch the resting state over months."
...
coverImage: "/api/og?title=The%20Mask%20Collection&subtitle=The%20Four%20Personas%20Every%20Sociopath%20Wears"
coverImageAlt: "The Mask Collection. Four personas sociopaths wear, from The Sociopathic Dating Bible"
author: "Kanika Batra"
faq:
  - q: "What are the four masks sociopaths wear?"
    a: "The Ingenue, the Therapist, the Femme Fatale, and the Boring Wife. The Ingenue disarms cynical men by making them feel like a hero, the Therapist extracts intelligence from men who want to be heard, the Femme Fatale exploits thrill-seekers with mystery, and the Boring Wife secures long-term commitment once the sociopath decides you're worth keeping."
  - q: "How does a sociopath choose which mask to wear?"
    a: "It isn't random. A skilled sociopath runs a 60-second diagnostic on every new man and maps his dominant weakness to the appropriate mask. Insecurity plus cynicism gets the Ingenue, unprocessed emotional history gets the Therapist, boredom plus ego gets the Femme Fatale, and life-stage readiness gets the Boring Wife. The match is made before the second date."
  - q: "Why isn't wearing a mask the same as lying?"
    a: "Because each mask is a complete operating mode the sociopath genuinely runs, not a cover story over a hidden true self. While the mask is active, they experience the world through that lens. There's no internal conflict, which is exactly why lie-detection techniques fail on a well-maintained mask: there's no physiological stress to catch."
  - q: "How can you tell if someone is wearing a mask?"
    a: "The single weakness is cross-mask inconsistency. Tired, drunk, stressed, or caught off-guard, a different mask bleeds through. Watch over a 3 to 6 month window: does her humour shift between contexts, does the vulnerable version use different vocabulary than the strong one, and which mask is her resting state when she thinks no one is watching?"
---
...
**What are the four masks sociopaths wear?**
The Ingenue, the Therapist, the Femme Fatale, and the Boring Wife. The Ingenue disarms cynical men by making them feel like a hero, the Therapist extracts intelligence from men who want to be heard, the Femme Fatale exploits thrill-seekers with mystery, and the Boring Wife secures long-term commitment once the sociopath decides you're worth keeping.

**How does a sociopath choose which mask to wear?**
It isn't random. A skilled sociopath runs a 60-second diagnostic on every new man and maps his dominant weakness to the appropriate mask. Insecurity plus cynicism gets the Ingenue, unprocessed emotional history gets the Therapist, boredom plus ego gets the Femme Fatale, and life-stage readiness gets the Boring Wife. The match is made before the second date.

**Why isn't wearing a mask the same as lying?**
Because each mask is a complete operating mode the sociopath genuinely runs, not a cover story over a hidden true self. While the mask is active, they experience the world through that lens. There's no internal conflict, which is exactly why lie-detection techniques fail on a well-maintained mask: there's no physiological stress to catch.

**How can you tell if someone is wearing a mask?**
The single weakness is cross-mask inconsistency. Tired, drunk, stressed, or caught off-guard, a different mask bleeds through. Watch over a 3 to 6 month window: does her humour shift between contexts, does the vulnerable version use different vocabulary than the strong one, and which mask is her resting state when she thinks no one is watching?
