...
const nextConfig = {
  trailingSlash: false,
  // The repo sits inside a monorepo whose root also has a package-lock.json,
  // so Next infers C:\AutonomousEmpire as the workspace root and scopes dev
  // tooling to that entire tree. Pin the root to this app.
