  ...
  const categories = await Promise.all([
    prisma.forumCategory.upsert({
      ...
      create: {
        ...
        description:
          "Open discussions about dark psychology, strategy, and social dynamics.",
        icon: "💬",
        sortOrder: 1,
    ...
    prisma.forumCategory.upsert({
      ...
      create: {
        ...
        description:
          "Tactical approaches to dating, attraction, and relationship dynamics.",
        icon: "💘",
        sortOrder: 2,
    ...
    prisma.forumCategory.upsert({
      ...
      create: {
        ...
        description:
          "Master the art of power, influence, and strategic thinking.",
        icon: "🖤",
        sortOrder: 3,
        accessTier: AccessTier.REGISTERED,
      },
    ...
    prisma.forumCategory.upsert({
      ...
      create: {
        ...
        description:
          "Exclusive discussions for book owners. Dive deep into the chapters.",
        icon: "📖",
        sortOrder: 4,
    ...
    prisma.forumCategory.upsert({
      ...
      create: {
        ...
        description:
          "Private space for coaching clients. Share progress and insights.",
        icon: "👑",
        sortOrder: 5,
  ...
  const chatRooms = await Promise.all([
    ...
    prisma.chatRoom.upsert({
      ...
      create: {
        ...
        description:
          "Connect with other practitioners of strategic psychology.",
        accessTier: AccessTier.REGISTERED,
