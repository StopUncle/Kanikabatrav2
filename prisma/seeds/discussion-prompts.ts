export const discussionPrompts = [
  ...
  },
  {
    title: "Manipulation Monday",
    content:
      "Think about the last time someone tried to guilt-trip you. What exact words did they use? How would you respond differently now versus a year ago?",
    dayOfWeek: 1,
    theme: "manipulation-monday",
    variation: 4,
  },
  ...
  },
  {
    title: "Toxic Tuesday",
    content:
      "Have you ever been the toxic one? Be honest. What pattern did you repeat before you became aware of it? Growth means owning the full picture, not just playing the victim.",
    dayOfWeek: 2,
    theme: "toxic-tuesday",
    variation: 3,
  },
  ...
  },
  {
    title: "Wisdom Wednesday",
    content:
      "Share a book, podcast, or concept that shattered your illusions about human nature. Something that made you see the world more clearly, even if the clarity was uncomfortable.",
    dayOfWeek: 3,
    theme: "wisdom-wednesday",
    variation: 2,
  },
  {
    title: "Wisdom Wednesday",
    content:
      "What's the hardest truth about relationships you've had to accept? The kind of thing you resisted for years but, once you accepted it, everything clicked into place.",
    dayOfWeek: 3,
    theme: "wisdom-wednesday",
    variation: 3,
  },
  ...
  // ============================================
  {
    ...
    content:
      "Think about a relationship pattern you've broken. What was the moment you saw it clearly? Was it a conversation, a gut feeling, or something you read that finally connected the dots?",
    dayOfWeek: 4,
  ...
  },
  {
    title: "Throwback Thursday",
    content:
      "Compare who you were in relationships one year ago versus today. What's the biggest shift? What would the old version of you not believe about the new version?",
    dayOfWeek: 4,
    theme: "throwback-thursday",
    variation: 2,
  },
  ...
  },
  {
    title: "Freedom Friday",
    content:
      "What's something you stopped tolerating this year that you used to accept without question? How did it feel the first time you refused to play along?",
    dayOfWeek: 5,
    theme: "freedom-friday",
    variation: 2,
  },
  ...
  // ============================================
  {
    ...
    content:
      "Present a real scenario you're dealing with right now (anonymous is fine). Let the community help you analyse it. What's happening, how do you feel about it, and what have you tried so far?",
    dayOfWeek: 6,
  ...
  },
  {
    title: "Situation Saturday",
    content:
      "Someone you care about is clearly being manipulated by their partner, but they can't see it yet. You've tried pointing it out and they got defensive. What's your next move? Share what's worked (or not worked) for you.",
    dayOfWeek: 6,
    theme: "situation-saturday",
    variation: 3,
  },
