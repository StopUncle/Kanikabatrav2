...
async function testQuizEmail() {
  ...
  const emailResult = await sendQuizResults({
    ...
    diagnosis: {
      ...
      functioningScore: 85,
      description:
        "Your profile indicates highly adaptive functioning. You demonstrate strong impulse control, consistent success patterns, and sophisticated self-awareness. This suggests you effectively channel your psychological patterns into productive outcomes while maintaining stable interpersonal relationships.",
    },
    primaryProfile: {
