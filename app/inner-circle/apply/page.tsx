...
export const metadata = {
  title: "Apply — The Inner Circle | Kanika Batra",
  description: "Apply to join The Inner Circle community",
};

export default async function ApplyPage() {
  const userId = await requireServerAuth("/inner-circle/apply");
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-32 pb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-text-gray max-w-lg mx-auto">
            The Inner Circle is a private community. We review every application
