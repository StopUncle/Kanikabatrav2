...
export default function VideosPage() {
  ...
  // Pre-fill title + description from a question's content. Shared by
  // the deep-link path and the picker's onChange wrapper, so picking
  // a question via either route frames the post as "Ask Kanika
  // answer". Empty-only: never clobbers a manual edit.
