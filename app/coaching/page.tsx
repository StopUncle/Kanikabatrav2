        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light mb-4 sm:mb-6">
              <span className="gradient-text">Transform Your Psychology</span>
            </h1>
            <p className="text-text-gray text-lg md:text-xl max-w-3xl mx-auto mb-8">
              One-on-one sessions with a diagnosed sociopath. Learn to think without emotion,
              see through manipulation, and wield power with surgical precision.
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm text-accent-gold">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Diagnosed sociopath insights</span>
              </div>
            </div>
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-light text-center mb-12">
              <span className="gradient-text">The Transformation Process</span>
            </h2>
              ...
              {[
                {
                  ...
                  description: 'Deep psychological analysis to identify your current mental framework, blind spots, and areas for optimization. We map your existing thought patterns and emotional responses.'
                },
                {
                  step: '02',
                  title: 'Strategy Development',
                  description: 'Custom-designed psychological strategies based on your specific goals and desired transformations. Each technique is tailored to your personality and circumstances.'
                },
                {
                  step: '03',
                  title: 'Implementation',
                  description: 'Guided practice with real-world scenarios, feedback loops, and continuous refinement of your new mindset. Bundle clients get ongoing support and reinforcement.'
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-light mb-4">
              <span className="gradient-text">Ready to Transform Your Mind?</span>
            </h2>
            <p className="text-text-muted mb-6 max-w-2xl mx-auto">
              Select your transformation path above, or contact us for a personalized recommendation
              based on your specific goals and current psychological profile.
            </p>
            <a
              href="/contact"
