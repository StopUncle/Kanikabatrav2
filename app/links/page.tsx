  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-950 to-black flex flex-col items-center py-12 px-4">
      ...
      >
        ...
        <p className="text-gold-400 text-sm mb-3">{SITE_CONFIG.title}</p>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div
                      className={`font-medium ${link.featured ? "text-white" : "text-white"}`}
                    >
                      {link.title}
                    </div>
                    <div
                      className={`text-sm ${link.featured ? "text-burgundy-200" : "text-gray-500"}`}
                    >
                      {link.subtitle}
                    </div>
                  </div>
