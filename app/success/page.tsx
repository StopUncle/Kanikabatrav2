        ...
        <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <div className="bg-deep-burgundy/20 border border-deep-burgundy/30 rounded-lg p-4 mb-4">
                  <p className="text-sm text-text-gray">
                    ...
                    download link is valid for 30 days with 30 downloads max.
            ...
            {isCoachingPurchase && (
              ...
              >
                ...
                <p className="text-text-gray mb-6">
                  Complete the pre-session questionnaire to get the most out of
                  our time together. You&apos;ll then receive a scheduling link
                  within 24-48 hours.
                </p>
                <button
                ...
                <div className="bg-deep-burgundy/20 border border-deep-burgundy/30 rounded-lg p-4">
                  <p className="text-sm text-text-gray">
                    <strong className="text-accent-gold">Note:</strong> The
                    questionnaire helps me prepare for our session and ensures
          ...
          >
            <p className="text-text-gray text-sm italic">
              &ldquo;Welcome to the darkness. Your transformation begins
              now.&rdquo;
            </p>
