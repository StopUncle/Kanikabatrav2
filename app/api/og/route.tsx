...
export async function GET(request: NextRequest) {
  ...
  const subtitle = searchParams.get("subtitle") || "The Psychology of Power";
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage:
          "linear-gradient(135deg, #0a0a0a 0%, #1a0a14 50%, #0f172a 100%)",
      }}
    >
      <div
        style={{
          ...
          bottom: 0,
          background:
            "radial-gradient(circle at 30% 20%, rgba(114, 33, 57, 0.3) 0%, transparent 50%)",
        }}
      />
      <div
        style={{
