        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-text-gray text-lg md:text-xl max-w-3xl mx-auto">
              Ready to transform your psychology? Have questions about my
              methods? Let&apos;s discuss how I can help you sharpen your
              mindset.
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-light text-text-gray mb-2"
                    >
                      Full Name *
                    </label>
                    <input
            ...
            <div className="space-y-8">
              ...
              <div className="bg-deep-black/30 backdrop-blur-sm border border-accent-gold/20 rounded-lg p-8">
                ...
                <p className="text-text-gray leading-relaxed mb-4">
                  Due to high demand, I&apos;m currently booking coaching
                  sessions 2-3 weeks in advance.
                </p>
