...
export async function generateMetadata({
  ...
  if (!categoryName) {
    return { title: "Category Not Found | Kanika Batra" };
  }

  return {
    title: `${categoryName} Articles | Kanika Batra`,
    description: `Read Kanika Batra's articles on ${categoryName.toLowerCase()}. Dark psychology, strategic thinking, and the patterns you keep repeating.`,
    alternates: {
      canonical: `${SITE_CONFIG.url}/blog/category/${slug}`,
    },
    openGraph: {
      title: `${categoryName} | Kanika Batra Blog`,
      description: `Articles on ${categoryName.toLowerCase()} by Kanika Batra.`,
      type: "website",
    },
  };
}
        ...
        <main className="pt-32 pb-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <nav className="mb-8 text-sm text-text-gray/60">
              ...
              <span className="mx-2">/</span>
              <span className="text-text-gray">{categoryName}</span>
            </nav>
