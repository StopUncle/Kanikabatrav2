...
export const metadata: Metadata = {
  ...
  description:
    "The first dating guide written by a clinically diagnosed sociopath. 15 chapters of strategic dating frameworks, psychological tactics, and manipulation mastery. Transform from victim to victor.",
  keywords:
    "sociopathic dating bible, dark psychology dating, manipulation tactics, dating strategy, kanika batra book, strategic psychology, relationship psychology",
  openGraph: {
