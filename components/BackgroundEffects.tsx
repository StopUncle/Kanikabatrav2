  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 overflow-hidden">
        ...
        />
        <div
          className={`absolute -bottom-32 -right-32 w-80 h-80 bg-accent-sapphire/20 rounded-full blur-3xl ${prefersReducedMotion ? "" : "animate-float-element animation-delay-5000"}`}
        />
        <div
          className={`absolute top-1/2 left-1/2 w-60 h-60 bg-accent-gold/10 rounded-full blur-3xl ${prefersReducedMotion ? "" : "animate-float-element animation-delay-10000"}`}
        />
      </div>
