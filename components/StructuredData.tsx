...
export function CoachingServiceSchema() {
  const schema = {
    ...
    description:
      "One-on-one coaching sessions with a diagnosed sociopath. Transform your psychology and master power dynamics.",
    provider: {
      "@type": "Person",
      name: "Kanika Batra",
      url: SITE_CONFIG.url,
...
export function QuizSchema() {
  const schema = {
    ...
    description:
      "Discover which Dark Triad personality type dominates your psychology. Are you a Narcissist, Machiavellian, or Psychopath?",
    educationalLevel: "All",
    about: {
      "@type": "Thing",
      name: "Dark Triad Personality",
      description:
        "The Dark Triad is a psychological construct that describes three personality traits: narcissism, Machiavellianism, and psychopathy.",
    },
    creator: {
      "@type": "Person",
      name: "Kanika Batra",
