...
export default function DashboardClient({ user }: DashboardClientProps) {
  ...
  const [mobileTab, setMobileTab] = useState<
    "overview" | "progress" | "achievements" | "account"
  >("overview");
  ...
  const stats = {
    ...
    completedSessions: (data?.user.sessions || []).filter(
      ...
      <main className="min-h-screen bg-deep-black pt-32 pb-24 md:pb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div
              className={`lg:col-span-2 space-y-8 ${mobileTab !== "overview" ? "hidden md:block" : ""}`}
            >
              {/* My Courses Section */}
              <DashboardCard
                title="My Courses"
            ...
            <div className="space-y-6">
              ...
              <div
                className={`${mobileTab !== "overview" && mobileTab !== "progress" ? "hidden md:block" : ""}`}
              >
                <ProgressOverview />
              </div>
              ...
              <div
                className={`${mobileTab !== "overview" && mobileTab !== "achievements" ? "hidden md:block" : ""}`}
              >
              ...
              <div
                className={`${mobileTab !== "overview" ? "hidden md:block" : ""}`}
              >
              ...
              <div
                className={`${mobileTab !== "overview" && mobileTab !== "account" ? "hidden md:block" : ""}`}
              >
                <AccountSection
                  email={user.email}
                  userId={user.userId}
