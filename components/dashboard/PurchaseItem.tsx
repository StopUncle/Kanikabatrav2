...
const PurchaseItem = ({
  ...
  return (
    <div className="group bg-gray-900/50 rounded-xl p-4 hover:bg-gray-900/70 transition-all duration-300 border border-gray-800 hover:border-accent-gold/30">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="flex-1">
              <h4 className="text-text-light font-semibold group-hover:text-accent-gold transition-colors">
                {title}
              </h4>
              <p className="text-text-gray text-sm mt-1">{description}</p>
            ...
            {downloadUrl && (
              <button
                ...
                className="flex-shrink-0 p-2 rounded-lg bg-accent-gold/10 hover:bg-accent-gold/20 transition-colors"
                aria-label="Download"
              >
