...
const DashboardCard = ({
  ...
  return (
    <div
      className={`bg-deep-black/30 backdrop-blur-sm rounded-lg border border-accent-gold/10 overflow-hidden ${className}`}
    >
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              {subtitle && (
                <p className="text-text-gray mt-1 text-sm sm:text-base">
                  {subtitle}
                </p>
              )}
            </div>
