  ...
  return (
    <div className="group relative">
      ...
      >
        ...
        {/* Name */}
        <p
          className={`${sizeStyle.text} font-medium text-center ${isEarned ? "text-text-light" : "text-gray-500"}`}
        >
          {name}
        </p>
        ...
        {/* Tier indicator */}
        <span
          className={`text-xs mt-1 capitalize ${isEarned ? tierStyle.text : "text-gray-600"}`}
        >
          {tier}
        </span>
