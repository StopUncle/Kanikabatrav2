...
const Header = () => {
  ...
  return (
    <>
            ...
            <div className="flex items-center justify-between h-16 sm:h-20">
                ...
                {navLinks.map((link) => {
                  ...
                  return (
                    ...
                    >
                      {link.label}
                      <span
                        className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-px bg-gradient-to-r from-transparent via-accent-gold to-transparent transition-all duration-300 ${
                          isActive
                            ? "w-full opacity-100"
                    ...
                    {isLoggedIn ? (
                      <>
                        ...
                        <button
                          ...
                          className="text-text-gray hover:text-accent-gold transition-colors text-sm"
                        >
                          Logout
                        </button>
                      </>
              ...
              >
                <div className="relative w-6 h-5 flex flex-col justify-between">
                  <span
                    className={`block h-px bg-accent-gold transition-all duration-300 origin-center ${
                      isMenuOpen ? "rotate-45 translate-y-2" : ""
                    }`}
                  />
                  <span
                    className={`block h-px bg-accent-gold transition-all duration-300 ${
      ...
      >
        <div
          className={`h-full flex flex-col px-6 py-8 overflow-y-auto overscroll-contain transition-all duration-500 delay-100 ${
            isMenuOpen
