...
export default function LoginForm() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      // cohort split /start makes. A returnTo of /start is resolved HERE
      // instead of pushed: /start would only look up the same membership
      // state we already hold and hop again, and every hop paints.
      let destination =
