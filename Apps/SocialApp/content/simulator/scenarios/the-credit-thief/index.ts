// The Credit Thief - Complete Scenario
// Free scenario - credit reclamation, evidence-based confrontation
...
export const theCreditThiefScenario: Scenario = {
  ...metadata,
  characters,
  scenes: allScenes,
  tacticsLearned,
...
export default theCreditThiefScenario;
