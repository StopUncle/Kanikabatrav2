// Level 3: The Gala - High Society (Apple-Safe Version)
...
export const levelMetadata = {
  id: LEVEL_ID,
  name: 'The Gala',
  description: 'An exclusive charity gala. High-net-worth individuals, potential allies, complex dynamics. This is where you master reading social situations.',
...
export const characters: Character[] = [
  ...
  },
  {
    id: 'jordan-gala',
    name: 'Jordan',
    description: 'The mysterious one. Old money, new connections.',
  ...
  },
  {
    id: 'the-ex',
    name: 'The Ex',
    description: 'Someone\'s ex. Complication incoming.',
